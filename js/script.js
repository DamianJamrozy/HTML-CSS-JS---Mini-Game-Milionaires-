...
function phone(){
	...
	okno = window.open('Sites/phone.html','Koło Ratunkowe - Telefon do Publiczności','width=800,height=400');
}
...
function people(){
	...
	sessionStorage.setItem("t3", type3);
	sessionStorage.setItem("t4", type4);
	okno = window.open('Sites/people.html','Koło Ratunkowe - Publiczność','width=800,height=400');
